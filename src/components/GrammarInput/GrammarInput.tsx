...
export default function GrammarInput({input, handleInput, handleRemove}: GrammarInputParam) {
  ...
  return (
    <div className='flex'>
      <input name='LH' type='text' value={input.LH} onInput={(e)=>handleInput(input.id, e)} />
      ...
      <input name='RH' type='text' value={input.RH} onInput={(e)=>handleInput(input.id, e)} />
      <button onClick={()=>handleRemove(input.id)}>
